    ...
    public class MyWritings
    {
        ...
        private List<Writing> MyAllWritings = new List<Writing>()
        {
           new Writing()
           {
                ...
                URL = "/writing/how-to-foster-a-positive-corporate-culture",
           ...
           new Writing()
           {
                ...
                URL = "/writing/the-importance-of-diversity-and-inclusion-in-the-workplace",
                Tags = "[\"all\", \"Writing\", \"Corporate Culture\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/the-more-you-get-to-Know-the-more-you-realize-what-you-dont-know",
           ...
           new Writing()
           {
                ...
                URL = "/writing//having-a-hard-day-make-it-better-with-an-act-of-kindness",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/learn-from-the-past-live-in-the-moment-and-prepare-for-the-future",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/small-consistent-efforts-are-more-sustainable-than-starting-too-big-and-burning-out",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/never-shrink-yourself-to-fit-into-places-you-have-outgrown",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/discipline-is-boring-but-it-is-worth-it",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/givers-should-know-their-limits-because-takers-often-dont-recognize-any",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/a-misunderstanding-after-a-deep-conversation",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/make-sure-others-opinions-on-you-arent-as-loud-as-your-own",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/there-is-no-someday-on-the-calendar-today-is-the-day-you-change-your-life",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/negative-self-talk",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/waiting-vs-acting-(the-power-of-taking-action-in-life)",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/as-long-as-you-are-trying-to-do-better-and-better-will-come",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
           ...
           new Writing()
           {
                ...
                URL = "/writing/focus-or-fail-the-power-of-staying-focused-for-success",
                Tags = "[\"all\", \"Writing\", \"Visual Storyteller\"]",
